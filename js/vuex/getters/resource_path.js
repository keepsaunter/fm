export default {
	...
	'ico_search': (state, getters) => getters.main_menu_selected==='douban'?state.ico_search_select:state.ico_search,
	'ico_mylisten': (state, getters) => getters.main_menu_selected==='qqmus'?state.ico_mylisten_select:state.ico_mylisten,
	'ico_mine': (state, getters) => getters.main_menu_selected==='wangyi'?state.ico_mine_select:state.ico_mine,
	...
	'ico_start': state => state.ico_start,
	'ico_pause': state => state.ico_pause,
